...
public class Mapper {
    ...
    /**
     * This method creates all of the clauses and outputs them to the buffer
     * defined by the constructor when the object was created.
     */
    public void buildSudokuClauses() {
        ...
        for (int k = 1; k <= NUM_VARS; k++) {
            for (int i = 1; i <= SQUARE_SIZE; i++) {
                ...
                for (int j = 1; j <= SQUARE_SIZE; j++) {
                    out.append(i).append(j).append(k).append(" ");
                }
                out.append("0\n");
            }
        }
    ...
    private void constraint_21A() {
        ...
        for (int k = 1; k <= NUM_VARS; k++) {
            for (int i = 1; i <= SQUARE_SIZE; i++) {
                for (int j = 1; j <= SQUARE_SIZE; j++) {
                    out.append(j).append(i).append(k).append(" ");
                }
                out.append("0\n");
            }
        }
            ...
            for (int n = 1; n <= SQUARE_SIZE; n++) {
                for (int j = 1; j <= SQUARE_SIZE; j++) {
                    ...
                    for (int i = j; i < SQUARE_SIZE; i++) {
                        out.append("-").append(n).append(j).append(k).append(" ");
                        out.append("-").append(n).append(j + ptr).append(k).append(" 0\n");
                        ptr++;
                    }
                }
            }
        ...
        for (int k = 1; k <= NUM_VARS; k++) {
            for (int n = 1; n <= SQUARE_SIZE; n++) {
                for (int j = 1; j <= SQUARE_SIZE; j++) {
                    int ptr = 1;
                    for (int i = j; i < SQUARE_SIZE; i++) {
                        out.append("-").append(j).append(n).append(k).append(" ");
                        out.append("-").append(j + ptr).append(n).append(k).append(" 0\n");
                        ptr++;
                    }
                }
            }
        ...
        for (int k = 1; k <= NUM_VARS; k++) {
            for (int m = 1; m <= SQUARE_SIZE; m += 3) {
                for (int n = 1; n <= SQUARE_SIZE; n += 3) {
                    ...
                    for (int i = 0; i < 3; i++) {
                        for (int j = 0; j < 3; j++) {
                            out.append(m + i).append(n + j).append(k).append(" ");
                        }
                    }
                    out.append("0\n");
                }
                ...
                for (int n = 1; n <= SQUARE_SIZE; n += 3) {
                    ...
                    for (int j = 0; j <= temp.length; j++) {
                        ...
                        for (int i = j; i < temp.length - 1; i++) {
                            out.append("-").append(temp[j]).append(" ");
                            out.append("-").append(temp[j + ptr]).append(" 0\n");
                            ptr++;
                        }
                    }
                }
    ...
    private void constraint_42() {
        for (int i = 1; i <= SQUARE_SIZE; i++) {
            for (int j = 1; j <= SQUARE_SIZE; j++) {
                for (int k = 1; k <= NUM_VARS; k++) {
                    for (int m = k + 1; m <= SQUARE_SIZE; m++) {
                        out.append("-").append(i).append(j).append(k).append(" ");
                        out.append("-").append(i).append(j).append(m).append(" 0\n");
                    }
                }
            }
        }
